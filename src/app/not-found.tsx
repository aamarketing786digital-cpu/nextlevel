...
export default function NotFound() {
  ...
  useGSAP(() => {
    ...
    for (let i = 0; i < 20; i++) {
      ...
      particle.className = "absolute w-2 h-2 bg-orange-500/30 rounded-full";
    ...
    <div ref={containerRef} className="relative min-h-screen flex items-center justify-center bg-teal-950 overflow-hidden pt-24 md:pt-32">
      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        ...
        <div className="not-found-404 relative inline-block mb-8">
          <h1 className="text-[150px] md:text-[200px] lg:text-[250px] font-display font-bold leading-none bg-gradient-to-br from-orange-400 via-orange-500 to-orange-600 bg-clip-text text-transparent select-none">
            404
          </h1>
          {/* Glow effect behind 404 */}
          <div className="absolute inset-0 bg-orange-500/20 blur-[80px] -z-10" />
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <Button
            asChild
            size="lg"
            className="not-found-btn rounded-full bg-orange-500 hover:bg-orange-400 text-slate-950 hover:shadow-[0_0_30px_rgba(242,151,39,0.3)] transition-all duration-300 text-lg px-8 h-14 font-medium"
          >
            <Link href="/">
        ...
        <div className="mt-16 mb-16 pt-12 pb-8 border-t border-white/10">
          ...
          <div className="flex flex-wrap justify-center gap-6 text-sm">
            ...
            <Link href="/contact" className="text-orange-400/80 hover:text-orange-400 transition-colors">
              Contact
            </Link>
          </div>
        </div>
