    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        <input
          ...
          className="w-full px-4 py-3.5 rounded-xl border border-slate-200 text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-amber-500/40 focus:border-amber-500 transition-all bg-slate-50/50"
        />
        <input
          type="email"
      ...
      <textarea
        ...
        className="w-full px-4 py-3.5 rounded-xl border border-slate-200 text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-amber-500/40 focus:border-amber-500 transition-all bg-slate-50/50 resize-none"
      />
      <button
        type="submit"
        disabled={isSubmitting}
        className="w-full bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 disabled:from-amber-300 disabled:to-amber-300 text-white font-bold py-4 rounded-xl transition-all flex items-center justify-center gap-2 shadow-lg shadow-amber-500/25 hover:shadow-amber-500/40 text-lg"
      >
        {isSubmitting ? (
          <>
    ...
    <>
      ...
      <section className="relative min-h-[90vh] flex items-center bg-slate-950 text-white overflow-hidden">
        ...
        <div className={`absolute bottom-20 left-10 w-[300px] h-[300px] blur-[100px] rounded-full pointer-events-none ${
          config.hero.accentColor === 'blue' ? 'bg-cyan-500/8' :
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-12">
          <FadeIn>
            <div className="text-center mb-16">
              <span className="inline-block text-sm font-semibold text-amber-600 tracking-widest uppercase mb-4">The Problem</span>
            ...
            {config.painPoints.items.map((item, i) => (
              <FadeIn key={i} delay={i * 0.12}>
                <div className="relative bg-gradient-to-br from-slate-50 to-white border border-slate-100 rounded-3xl p-8 lg:p-10 h-full hover:shadow-2xl hover:shadow-slate-200/60 hover:-translate-y-1 transition-all duration-500 group overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-br from-amber-500/[0.02] to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-3xl" />
                  
                  <div className="relative">
                    <div className="w-16 h-16 rounded-2xl bg-amber-50 border border-amber-100 flex items-center justify-center text-3xl mb-6">
                      {item.icon}
                    </div>
          ...
          <FadeIn delay={0.4}>
            <div className="text-center mt-14">
              <button
                onClick={scrollToForm}
                className="inline-flex items-center gap-2 text-amber-600 hover:text-amber-700 font-bold text-lg transition-colors group"
              >
      ...
      <section className="relative py-24 md:py-32 bg-slate-950 text-white overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-amber-500/5 blur-[200px] rounded-full pointer-events-none" />

        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-12">
          <FadeIn>
            <span className="inline-block text-sm font-semibold text-amber-400 tracking-widest uppercase mb-6">Proven Results</span>
          </FadeIn>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <FadeIn>
              <div>
                <div className="text-8xl md:text-9xl font-black bg-gradient-to-br from-amber-300 via-amber-400 to-amber-500 bg-clip-text text-transparent mb-3 leading-none">
            ...
            <FadeIn delay={0.15}>
              <div className="bg-white/[0.04] border border-white/[0.08] rounded-3xl p-8 lg:p-10 backdrop-blur-md">
                <svg className="w-10 h-10 text-amber-400/60 mb-5" viewBox="0 0 24 24" fill="currentColor">
      ...
      <section className="py-24 md:py-32 bg-slate-50 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-12">
          <FadeIn>
            <div className="text-center mb-16">
              <span className="inline-block text-sm font-semibold text-amber-600 tracking-widest uppercase mb-4">How It Works</span>
            ...
            {config.process.steps.map((step, i) => (
              <FadeIn key={i} delay={i * 0.12}>
                <div className="relative bg-white rounded-3xl p-8 lg:p-10 shadow-lg shadow-slate-200/50 border border-slate-100 h-full">
                  {/* Step number */}
                  <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-amber-400 to-amber-500 flex items-center justify-center text-white font-black text-xl mb-6 shadow-lg shadow-amber-400/20">
                    {step.number}
                  </div>
                  {/* Arrow connector for non-last items */}
                  {i < config.process.steps.length - 1 && (
                    <div className="hidden md:block absolute -right-4 top-1/2 -translate-y-1/2 z-10">
                      <ArrowRight className="w-8 h-8 text-amber-400/40" />
                    </div>
                  )}
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 md:px-8">
          <FadeIn>
            <div className="text-center mb-14">
              <span className="inline-block text-sm font-semibold text-amber-600 tracking-widest uppercase mb-4">Got Questions?</span>
              <h2 className="text-3xl md:text-5xl font-bold text-slate-900 tracking-tight">
                Common Questions
              </h2>
            </div>
            ...
            <div className="bg-slate-50 rounded-3xl p-6 md:p-10 border border-slate-100">
              <Accordion type="single" collapsible className="w-full">
                {config.faq.items.map((item, index) => (
                  ...
                  >
                    <AccordionTrigger className="text-left text-lg font-semibold text-slate-800 hover:text-amber-600 transition-colors py-5">
                      {item.question}
                    </AccordionTrigger>
      ...
      <section
        ref={formRef}
        className="relative py-24 md:py-32 bg-slate-950 text-white overflow-hidden"
      >
        {/* Background image */}
        <div className="absolute inset-0 z-0">
          <Image
        ...
        <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-amber-500/8 blur-[150px] rounded-full pointer-events-none" />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              <FadeIn>
                <span className="inline-block text-sm font-semibold text-amber-400 tracking-widest uppercase mb-6">Get Started</span>
