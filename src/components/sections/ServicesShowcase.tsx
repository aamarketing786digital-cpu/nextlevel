...
function MobileServices() {
  ...
  useGSAP(() => {
    ...
    const cards = gsap.utils.toArray<HTMLElement>(".mobile-service-card", sectionRef.current);
    cards.forEach((card) => {
      gsap.fromTo(card,
...
function DesktopServices() {
  ...
  useGSAP(() => {
    ...
    const panels = gsap.utils.toArray<HTMLElement>(".service-panel", triggerRef.current);
         ...
         onUpdate: (self) => {
            ...
            if (newIndex !== activeIndexRef.current) {
                ...
                requestAnimationFrame(() => {
                  ...
                  if (oldBtn) {
                      oldBtn.classList.remove("bg-teal-900", "text-white", "shadow-sm", "font-bold");
                  ...
                  if (newBtn) {
                      ...
                      newBtn.classList.add("bg-teal-900", "text-white", "shadow-sm", "font-bold");
                  }
